...
# Aggregate importance by parent variable and keep top features (e.g., keep until 90% cumulative gain)
keep_features <- xgb.importance(model = best_model, trees = 0:(best_iter - 1)) |>
  tibble::as_tibble() |>
  dplyr::mutate(
    Feature = purrr::map_chr(Feature, \(f) {
      if (f %in% voi_num) return(f)
...
# Split into numeric / categorical groups
keep_num <- intersect(voi_num, keep_features)
keep_num
# > [1] "EXERPRAC" "WORKPAY"  "WORKHOME" "HOMEPOS"  "ICTRES"   "INFOSEEK" "BULLIED"  "GROSAGR"  "ANXMAT"   "MATHEFF"  "MATHEF21" "FAMCON"   "ASSERAGR" "CURIOAGR" "EMOCOAGR" "EXPOFA"  
# > [17] "COGACRCO" "COGACMCO" "CREATSCH" "CREATEFF" "CREATOP"  "CREATAS"  "CREATOOS" "FAMSUPSL" "FEELLAH"  "PROBSELF" "SCHSUST"  "LEARRES"  "ESCS"     "OPENCUL"  "DIGPREP" 
keep_cat <- intersect(voi_cat, keep_features)
keep_cat
# > character(0)

# voi <- c(
#   "EXERPRAC","WORKPAY","WORKHOME","HOMEPOS","ICTRES","INFOSEEK",
#   "BULLIED","GROSAGR","ANXMAT","MATHEFF","MATHEF21","FAMCON",
#   "ASSERAGR","CURIOAGR","EMOCOAGR","EXPOFA","COGACRCO","COGACMCO",
#   "CREATSCH","CREATEFF","CREATOP","CREATAS","CREATOOS","FAMSUPSL",
#   "FEELLAH","PROBSELF","SCHSUST","LEARRES","ESCS","OPENCUL","DIGPREP"
# ) 


## ---- ** Repeat the process with selected variables ** ----
#
# Revisit: use 80/10/10 split; change oos to voi
#
# ---- II. Predictive Modelling: Version 2.4a ----
...
# ---- II. Predictive Modelling: Version 2.4b ----
...
# Side-by-side comparison 
print(as.data.frame(dplyr::bind_rows(metrics_cv, metrics_oof, metrics)), row.names = FALSE)
# oos expanded Version 2.4b
# >      Model    Dataset     RMSE      MAE          Bias     Bias%        R2
# >      CV-best   Training 47.63430 36.46982  1.655941e-05 1.4266660 0.7442956
# >      CV-best Validation 69.89447 55.01789 -1.557704e+00 1.9203988 0.4416836
# >      CV-best       Test 69.09419 54.53049 -6.002482e+00 0.9570216 0.4814457
# >      OOF-best   Training 47.63430 36.46982  1.655941e-05 1.4266660 0.7442956
# >      OOF-best Validation 69.89447 55.01789 -1.557704e+00 1.9203988 0.4416836
# >      OOF-best       Test 69.09419 54.53049 -6.002482e+00 0.9570216 0.4814457
# >      VALID-best   Training 47.42213 36.28006  9.201205e-05 1.4178963 0.7465684
# >      VALID-best Validation 69.88528 55.02265 -1.584697e+00 1.9126169 0.4418304
# >      VALID-best       Test 69.08877 54.51129 -5.999220e+00 0.9560372 0.4815270

# oos expanded Version 2.4a
# >      Model    Dataset     RMSE      MAE          Bias    Bias%        R2
# >    CV-best   Training 44.33802 34.61516 -0.0001679548 1.080060 0.7565160
# >    CV-best Validation 71.25617 55.63241 -0.8468597611 1.934017 0.4170327
# >    CV-best       Test 63.81214 50.01871 -1.2277011815 1.272871 0.4834889
# >   OOF-best   Training 44.33802 34.61516 -0.0001679548 1.080060 0.7565160
# >   OOF-best Validation 71.25617 55.63241 -0.8468597611 1.934017 0.4170327
# >   OOF-best       Test 63.81214 50.01871 -1.2277011815 1.272871 0.4834889
# > VALID-best   Training 50.27998 39.61419 -0.1251414362 1.271139 0.6868820
# > VALID-best Validation 70.98631 55.36370 -1.1502509177 1.910968 0.4214400
# > VALID-best       Test 64.17162 50.30512 -1.4861225896 1.271092 0.4776532
